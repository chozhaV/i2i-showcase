          ...
          <div class="animate-on-scroll">
            <div class="card">
              ...
              >
                ...
                <button type="submit" class="i2i-light-button text-center w-full flex items-center justify-center">
              ...
              <div
                *ngIf="showSuccess"
                class="mt-6 p-4 bg-green-500/20 border border-green-500/50 rounded-lg"
              >
              ...
              <div class="space-y-3">
                <div class="flex items-center space-x-3">
                  ...
                  <span class="text-gray-600"
                    >Free consultation and project assessment</span
                  >
                </div>
                <div class="flex items-center space-x-3">
                  <svg
                ...
                <div class="flex items-center space-x-3">
                  ...
                  <span class="text-gray-600"
                    >Expert technical support and guidance</span
                  >
                </div>
                <div class="flex items-center space-x-3">
                  <svg
                  ...
                  <span class="text-gray-600"
                    >Quick response time within 24 hours</span
                  >
                </div>
              </div>
            </div>
...
export class ContactComponent implements OnInit, OnDestroy {
  ...
  ngOnInit(): void {
    ...
    // Handle product quote requests from query params
    this.route.queryParams
      .pipe(takeUntil(this.destroy$))
      .subscribe((params) => {
        if (params['product'] && params['sku']) {
          const message = `I would like to get a quote for ${params['product']} (SKU: ${params['sku']}).`;
  ...
  async onSubmit(): Promise<void> {
    if (this.contactForm.valid) {
      ...
      this.http.post('https://formspree.io/f/mjkogood', formData1).subscribe({
        next: (response) => {
