...
@Component({
  ...
  template: `
    <footer class="bg-dark-900 border-t border-dark-700 mt-20">
      <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="space-y-4">
            <div class="flex items-center space-x-3">
              ...
              <div>
                <h3 class="text-lg font-bold text-white">i2i Smart Enterprises</h3>
            ...
            <div class="flex space-x-4">
              <a href="#" class="text-dark-400 hover:text-primary-400 transition-colors duration-300">
          ...
          <!-- Product Categories -->
          <div class="space-y-4">
            <h4 class="text-lg font-semibold text-white">Solutions</h4>
            <nav class="flex flex-col space-y-2">
              <a href="#" class="footer-link">Education Technology</a>
              <a href="#" class="footer-link">Security Systems</a>
              <a href="#" class="footer-link">Smart Infrastructure</a>
              <a href="#" class="footer-link">Safety Systems</a>
            </nav>
          </div>
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-3">
              <div class="flex items-start space-x-3">
                ...
                <p class="text-dark-400 text-sm">123 Technology Street<br>Smart City, SC 12345</p>
              </div>
              <div class="flex items-center space-x-3">
                <svg class="w-5 h-5 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"></path>
                </svg>
                <p class="text-dark-400 text-sm">+1 (555) 123-4567</p>
              </div>
              <div class="flex items-center space-x-3">
                <svg class="w-5 h-5 text-primary-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                </svg>
                <p class="text-dark-400 text-sm">info&#64;i2ismartenterprises.com</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="border-t border-dark-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p class="text-dark-400 text-sm">
            © 2025 i2i Smart Enterprises. All rights reserved.
          </p>
  ...
  styles: [`
    .footer-link {
      @apply text-dark-400 hover:text-primary-400 transition-colors duration-300 text-sm;
    }
  `]
})
