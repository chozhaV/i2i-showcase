...
@Component({
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="space-y-4">
            ...
            <div class="flex space-x-4">
              <a
                href="#"
                class="text-gray-500 hover:text-primary-400 transition-colors duration-300"
              >
          ...
          <!-- Product Categories -->
          <div class="space-y-4">
            <h4 class="text-lg font-semibold text-gray-900">Solutions</h4>
            <nav class="flex flex-col space-y-2">
          ...
          <!-- Contact Info -->
          <div class="space-y-4">
            <h4 class="text-lg font-semibold text-gray-900">Contact Info</h4>
            <div class="space-y-3">
              <div class="flex items-start space-x-3">
                ...
                <p class="text-gray-600 text-sm">
                  No:34, Karnan St,<br />Selliamman Nagar, Otteri,<br />Killambakkam,
  ...
  styles: [
    `
      .footer-link {
        @apply text-gray-600 hover:text-primary-400 transition-colors duration-300 text-sm;
      }
    `,
  ],
})
