  ...
  template: `
    <footer class="bg-dark-900 border-t border-dark-700 mt-20">
      <div class="container mx-auto px-4 py-12">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div class="space-y-4">
            ...
            <p class="text-dark-400 text-sm leading-relaxed">
              Leading provider of advanced technology solutions across
              education, security, and smart infrastructure domains.
            </p>
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-3">
              <div class="flex items-start space-x-3">
                <svg
                  class="w-5 h-5 text-primary-400 mt-0.5"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <div class="flex items-center space-x-3">
                ...
                <p class="text-dark-400 text-sm">+91 95663 48780 <br> +91 99625 45546</p>
              </div>
              <div class="flex items-center space-x-3">
                <svg
                  class="w-5 h-5 text-primary-400"
        ...
        <!-- Bottom Section -->
        <div
          class="border-t border-dark-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center"
        >
          <p class="text-dark-400 text-sm">
